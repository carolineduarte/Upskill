...
import upskill.porto.exception.NomePessoaInvalidoException;
import upskill.porto.exception.NifInvalidoException;
...
public class Pessoa implements Serializable{
    ...
    public void setNome(String nome) throws NomePessoaInvalidoException{
        if(eNomeValido(nome)) {
            this.nome = nome;
        }else {throw new NomePessoaInvalidoException(nome+ ": Nome inv ́alido");
        }
    }
